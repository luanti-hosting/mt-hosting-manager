...
func (api *Api) Setup() {
	...
	apir.HandleFunc("/exchange_rate", HandleRestGet(api.repos.ExchangeRateRepo.GetAll))
	apir.HandleFunc("/exchange_rate/{currency}", HandleRestGetParamSingle("currency", api.repos.ExchangeRateRepo.GetByCurrency))
	...
	admin_api.HandleFunc("/user", HandleRestGet(api.repos.UserRepo.GetAll)).Methods(http.MethodGet)
	admin_api.HandleFunc("/user/search", api.SearchUser).Methods(http.MethodPost)
	admin_api.HandleFunc("/user/{id}", api.SaveUser).Methods(http.MethodPost)
	admin_api.HandleFunc("/nodetype", api.CreateNodeType).Methods(http.MethodPost)
	admin_api.HandleFunc("/nodetype/{id}", api.UpdateNodeType).Methods(http.MethodPost)
	admin_api.HandleFunc("/nodetype/{id}", api.DeleteNodeType).Methods(http.MethodDelete)
	admin_api.HandleFunc("/job", api.GetJobs).Methods(http.MethodGet)
	admin_api.HandleFunc("/job/{id}", api.DeleteJob).Methods(http.MethodDelete)
	admin_api.HandleFunc("/job/{id}", api.RetryJob).Methods(http.MethodPost)

	admin_api.HandleFunc("/exchange_rate", HandleRestCreate(api.repos.ExchangeRateRepo.Insert)).Methods(http.MethodPost)
	admin_api.HandleFunc("/exchange_rate/{currency}", HandleRestCreate(api.repos.ExchangeRateRepo.Update)).Methods(http.MethodPut)
	admin_api.HandleFunc("/exchange_rate/{currency}", HandleRestDelete("currency", api.repos.ExchangeRateRepo.DeleteByCurrency)).Methods(http.MethodDelete)

	admin_api.HandleFunc("/coupon", api.CreateCoupon).Methods(http.MethodPost)
	admin_api.HandleFunc("/coupon", api.GetCoupons).Methods(http.MethodGet)
	admin_api.HandleFunc("/coupon/{id}", api.GetCoupon).Methods(http.MethodGet)
	admin_api.HandleFunc("/coupon/{id}/users", api.GetCouponUsers).Methods(http.MethodGet)
	admin_api.HandleFunc("/coupon/{id}", api.UpdateCoupon).Methods(http.MethodPost)
